...
-- escape_room_challenges base table, attempts) gets no policy at all, which
-- means default-deny for anon: readable only by the service role from
-- Next.js Route Handlers, or by SECURITY DEFINER functions.
--
